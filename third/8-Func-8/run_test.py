...
TEST_ID = 'Func-8'
ALGORITHM_NAME = '贷款发放决策算法'
METHOD_NAME = 'Rasengan 分组特征选择电路'
BASELINE_NAME = 'Penalty-QAOA 电路'
APPLICATION_MODULE = 'loan_decision.py'
ALGORITHM_DIR = 'rasengan'
RELATED_TEST_DIRS = ['18-Func-18', '28-Func-28', '38-Func-38', '49-Perf-8', '61-Perf-20', '71-Perf-30', '127-Perf-48', '137-Perf-58']
