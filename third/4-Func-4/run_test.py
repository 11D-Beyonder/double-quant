...
TEST_ID = 'Func-4'
ALGORITHM_NAME = '动态账本更新算法'
METHOD_NAME = '优化动态账本 Shor 周期发现电路'
BASELINE_NAME = '通用 Shor 周期发现量子基线'
APPLICATION_MODULE = 'dynamic_ledger_update.py'
ALGORITHM_DIR = 'shor'
RELATED_TEST_DIRS = ['14-Func-14', '24-Func-24', '34-Func-34', '45-Perf-4', '57-Perf-16', '67-Perf-26', '123-Perf-44', '133-Perf-54']
