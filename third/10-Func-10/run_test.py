...
TEST_ID = 'Func-10'
ALGORITHM_NAME = '指数追踪算法'
METHOD_NAME = 'Rasengan 行业约束篮子搜索电路'
BASELINE_NAME = 'Penalty-QAOA 电路'
APPLICATION_MODULE = 'index_tracking.py'
ALGORITHM_DIR = 'rasengan'
RELATED_TEST_DIRS = ['20-Func-20', '30-Func-30', '40-Func-40', '51-Perf-10', '63-Perf-22', '73-Perf-32', '129-Perf-50', '139-Perf-60']
