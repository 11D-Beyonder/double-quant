...
TEST_ID = 'Func-7'
ALGORITHM_NAME = '支付与结算系统算法'
METHOD_NAME = 'Rasengan 流动性中性搜索电路'
BASELINE_NAME = 'Penalty-QAOA 电路'
APPLICATION_MODULE = 'payment_settlement.py'
ALGORITHM_DIR = 'rasengan'
RELATED_TEST_DIRS = ['17-Func-17', '27-Func-27', '37-Func-37', '48-Perf-7', '60-Perf-19', '70-Perf-29', '126-Perf-47', '136-Perf-57']
