...
TEST_ID = 'Func-5'
ALGORITHM_NAME = '去中心化金融管理算法'
METHOD_NAME = 'SFS+Grover 压缩搜索电路'
BASELINE_NAME = '普通 Grover 量子搜索电路'
APPLICATION_MODULE = 'defi_management.py'
ALGORITHM_DIR = 'grover'
RELATED_TEST_DIRS = ['15-Func-15', '25-Func-25', '35-Func-35', '46-Perf-5', '58-Perf-17', '68-Perf-27', '124-Perf-45', '134-Perf-55']
